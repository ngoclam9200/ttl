export default function ItemFeature({
  ...
  return (
    <div className="w-full rounded-lg overflow-hidden shadow-lg flex flex-col items-center md:gap-4 gap-3 p-[0.625rem]">
      ...
      <div className="w-full h-full text-center md:text-[2rem] text-[1.5rem] font-bold">
        {value}
      </div>
      <div className="w-full h-full text-center md:text-[0.875rem] text-[0.85rem] text-gray">
        {description}
      </div>
    </div>
  );
